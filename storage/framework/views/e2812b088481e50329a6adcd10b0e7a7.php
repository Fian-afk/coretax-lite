    ...
    <main class="container mx-auto px-4 py-6 pt-16">
        <div class="bg-white rounded shadow-sm p-6 my-6 mt-6">
            <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div class="flex-1">
                    <h1 class="text-2xl font-semibold text-gray-800"><?php echo e(Auth::user()->username); ?></h1>
                    <p class="text-gray-500"><?php echo e(Auth::user()->email); ?></p>
                    <div class="flex items-center mt-2">
                        <span class=" text-sm text-gray-500">Bergabung sejak <?php echo e(Auth::user()->created_at); ?></span>
                    </div>
                </div>
            ...
            <div id="content-info" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-gray-50 p-4 rounded">
                        ...
                        <p class="text-2xl font-semibold text-gray-800"><?php echo e(\App\Models\Document::where('user_id', Auth::id())->count()); ?></p>
                        <?php
                            $unggahanBulanIni = \App\Models\Document::where('user_id', Auth::id())
                                ->where('created_at', '>=', Carbon::now()->subMonth())
                                ->count();
                        ?>
                        <p class="text-sm text-gray-500"><?php echo e($unggahanBulanIni); ?> unggahan dalam 1 bulan terakhir</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded">
                        <div class="flex items-center justify-between mb-2">
                        ...
                        <p class="text-2xl font-semibold text-gray-800">
                            <?php echo e(\App\Models\Download::where('user_id', Auth::id())->count()); ?>

                        </p>
                        <p class="text-sm text-gray-500"><?php echo e(\App\Models\Download::where('user_id', Auth::id())->count()); ?> unduhan dalam 1 bulan terakhir</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded">
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="font-medium"><?php echo e(Auth::user()->username ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Bio</p>
                            <p class="font-medium"><?php echo e(Auth::user()->profile->bio ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Asal Instansi</p>
                            <p class="font-medium"><?php echo e(Auth::user()->profile->instansi ?? '-'); ?></p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-medium"><?php echo e(Auth::user()->telp ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Alamat</p>
                            <p class="font-medium"><?php echo e(Auth::user()->profile->address ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e(Auth::user()->documents->title ?? '-'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
...
</html><?php /**PATH C:\xampp\htdocs\Pemrograman Web\coretax-lite-restore-laravel10 (1)\coretax-lite-restore-laravel10\resources\views/profil.blade.php ENDPATH**/ ?>