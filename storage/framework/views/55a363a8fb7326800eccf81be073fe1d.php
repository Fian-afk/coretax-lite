            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="instansi" name="instansi" value="<?php echo e($profile->instansi ?? ''); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="location" name="address" value="<?php echo e($profile->address ?? ''); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary">
                    </div>
                ...
                <input type="hidden" name="history-upload-document" value="<?php echo e(\App\Models\Document::where('user_id', Auth::id())->count()); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\Pemrograman Web\coretax-lite-restore-laravel10 (1)\coretax-lite-restore-laravel10\resources\views/profile/edit.blade.php ENDPATH**/ ?>